...
function Card(props) {
  const {text, imageUrl, user} = props.post;
          ...
          <View style={styles.row}>
            ...
            <View style={styles.headingCon}>
              <Text
                style={
                  styles.heading
                }>{`${user[0]?.name?.first} ${user[0]?.name?.last}`}</Text>
              <Text style={styles.subheading}>{user[0]?.position}</Text>
            </View>
          </View>

          <View style={styles.center}>
            {/* <Text>Test</Text> */}
            <Icon name="options-vertical" size={18} />
          </View>
        </View>
      ...
      <View style={styles.mt}>
        <View style={styles.row}>
          <View style={styles.col}>
            <AntDesign name="like2" color={'#3F93C1'} size={20} />
            <Text style={styles.TextSize}>Like</Text>
          </View>
          <View style={styles.col_1}>
            <Feather name="message-circle" color={'#3F93C1'} size={20} />
            <Text style={styles.TextSize}>Comment</Text>
          </View>
          <View style={styles.col_1}>
            <AntDesign name="sharealt" color={'#3F93C1'} size={20} />
            <Text style={styles.TextSize}>Share</Text>
          </View>
          <View style={styles.col_1}>
            <Feather name="send" color={'#3F93C1'} size={20} />
            <Text style={styles.TextSize}>Share</Text>
          </View>
        </View>
              ...
              {icon ? (
                <View style={styles.dis}>
                  <Feather
                    ...
                    style={styles.mr}
                  />
                  <Feather name="send" color={'#3F93C1'} size={18} />
                </View>
              ) : (
                <></>
              )}
